...
prompt = PromptTemplate(
    template="""
      ...
      Answer  from the provided transcript context and message. where message is the chat history.
    ...
    """,
    input_variables = ['context', 'question','message']
)
...
def main():
    ...
    """,
    input_variables = ['context', 'question','message']
).invoke({"context": state["context"], "question": state["question"],"message":st.session_state.messages})
